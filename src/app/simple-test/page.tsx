    ...
    <div className="p-8 max-w-2xl mx-auto">
      ...
      <div className="space-y-4">
        <div className="p-4 bg-gray-800 rounded-lg">
          ...
          <p><strong>Mount Time:</strong> {mountTime?.toLocaleTimeString() || 'Not set'}</p>
          <p><strong>Current Time:</strong> {currentTime.toLocaleTimeString()}</p>
          <p><strong>Time Since Mount:</strong> {mountTime ? Math.floor((currentTime.getTime() - mountTime.getTime()) / 1000) : 0}s</p>
        </div>
        ...
        {isLoaded && !isSignedIn && (
          <div className="p-4 bg-yellow-800 rounded-lg">
            <p className="text-yellow-200">
              ✅ Clerk is loaded but you're not signed in. This is normal behavior.
            </p>
          </div>
        )}
